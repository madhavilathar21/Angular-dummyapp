...
@Component({
  selector: 'app-payment-rejection-compare',
  templateUrl: './payment-rejection-compare.component.html',
  styleUrls: ['./payment-rejection-compare.component.css']
})
export class PaymentRejectionCompareComponent implements OnInit {
